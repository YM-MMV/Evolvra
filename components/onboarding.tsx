      ...
      <main className="onboarding-card">
        ...
        {step === 0 && (
          <div className="onboarding-content">
            ...
            <p className="lead">Connect meaningful goals to real-world progress, focused actions, and the qualities you are developing — with room for real life and changing priorities.</p>
        ...
        {step === 2 && (
          <div className="onboarding-content">
            ...
            <div className="choice-grid" role="group" aria-label="Starting workspace">
              <button type="button" aria-pressed={starter} className={starter ? "choice active" : "choice"} onClick={() => setStarter(true)}><span className="choice-check"><Check size={15} /></span><Sparkles /><strong>Starter workspace</strong><small>See goals, quests, metrics, milestones, and reviews in action.</small></button>
              <button type="button" aria-pressed={!starter} className={!starter ? "choice active" : "choice"} onClick={() => setStarter(false)}><span className="choice-check"><Check size={15} /></span><Target /><strong>Clean workspace</strong><small>Keep the suggested structure, but create every goal yourself.</small></button>
            </div>
