...
function GoalsContent() {
  ...
  return <div>
    ...
    <div className="toolbar panel">
      ...
      <div className="view-switcher"><button className={view === "cards" ? "active" : ""} onClick={() => setView("cards")} aria-label="Card view"><LayoutGrid size={17} /></button><button className={view === "list" ? "active" : ""} onClick={() => setView("list")} aria-label="List view"><List size={18} /></button><button className={view === "board" ? "active" : ""} onClick={() => setView("board")} aria-label="Board view"><Columns3 size={17} /></button></div>
    </div>
