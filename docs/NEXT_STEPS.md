...
5. With explicit production approval, pause old-client editing, apply migrations 001 through 008 with Supabase CLI 2.109.1, and immediately promote the compatible client.
